...
/**
 * Object to hold default values used by [_root_ide_package_.com.mohyeddin.datepicker.date.DatePicker()]
 */
object DatePickerDefaults {
    /**
     * Initialises a [DatePickerColors] object which represents the different colors used by
     * the [_root_ide_package_.com.mohyeddin.datepicker.date.DatePicker()] composable
